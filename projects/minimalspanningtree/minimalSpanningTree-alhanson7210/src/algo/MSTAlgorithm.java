...
//        // Felt is was more efficient and useful to have two hash maps with the one here being used for making printing easier
//        HashMap<Integer, String[]> costs = Graph.getCostHash();
        String[] cityNames = graph.getCities();
        System.out.print("\nSource\tDestination");
        for(Edge edge : edgesMST) System.out.print(String.format("\n%s\t%s", cityNames[edge.getId1()], cityNames[edge.getId2()]));
//            String[] snd = costs.get(edge.getCost());
